 ...
 <%@ page contentType="text/html; charset=UTF-8" %>
    ...
    <div id="myCarousel" class="carousel slide">
      <div class="carousel-inner">
        <div class="item">
          <img src="resources/image/slide-01-77.jpg" alt="">
          <div class="container">
        ...
        <div class="item active">
          <img src="resources/image/slide-03.jpeg" alt="">
          <div class="container">
            <div class="carousel-caption">
    ...
    <div class="container marketing">
      ...
      <div class="row">
        <div class="span4">
          <img class="img-circle" data-src="holder.js/140x140" alt="140x140" src="resources/image/1.png" style="width: 140px; height: 140px;">
